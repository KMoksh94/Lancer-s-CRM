...
const Topbar = ({currentTab,user,setToken}) => {
  return (
    <div className='sticky top-0 w-full h-25 md:h-15 flex flex-col md:flex-row md:items-center md:justify-between px-6 bg-white z-50 space-y-3 md:space-y-0 py-2 md:py-0' >
